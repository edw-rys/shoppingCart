...
<main class="my-profile flex flex-center <?php echo $data["myGender"]->name_gender?>" >
    <div class="container-profile grid">
        <section class="my-data">
            ...
            <div class="info flex flex-y picture">
                ...
                <span class="flex space-btw">
                    <span><b>País: </b></span><span><?php echo $data["myCountry"]->name_cy?></span>
                </span>
                <span class="flex space-btw">
                    <span><b>Género: </b></span><span><?php echo $data["myGender"]->name_gender?></span>
                </span>
            
            </div>
            <div class="edit picture flex-center">
                <b><a href="<?php echo URL?>user/edit">Editar datos</a></b>
            </div>
        ...
        <div class="muro">
            ...
            if($user->getId_typeuser()==CLIENT){
                include_once COMPONENTS."muroCliente.php";
            }else if($user->getId_typeuser()==ADMIN){
                include_once COMPONENTS."muroAdmin.php";
            }
            ?>
        </div>
    </div>
